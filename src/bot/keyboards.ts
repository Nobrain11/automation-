...
export function mainKeyboard() {
  return new InlineKeyboard()
    ...
    .text("📈 LIMIT ORDERS", "buy:start")
    .row()
    .text("💰 DEPOSIT", "wallet:menu")
    .text("↔️ TRANSFER", "wallet:menu")
    .text("💸 WITHDRAW", "wallet:menu")
    .row()
    .text("🎁 REFER & EARN", "referral")
    .row()
    .text("👛 WALLETS", "wallet:menu")
